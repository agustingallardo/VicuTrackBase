...
//! Define constantes relacionadas al OCR
#define SD_OCR_VOLTAGE_3_3V        (0x00300000L)
#define SD_OCR_CCS                 (0x40000000L)
#define SD_OCR_POWER_UP_STATUS     (0x80000000L)

//! Define constante para definir la respuesta al comando 41
#define SD_ACMD41_HCS              (0x40000000L)

//! Define constantes para identificar los distintos tipos de comandos
